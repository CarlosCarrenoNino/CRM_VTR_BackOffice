...
<html lang="es">
    <head>
        ...
        <title>Registrarse | CRM Falabella</title>
                                ...
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    ...
                                    <div class="card-body">
                                        <form>
                                            <div class="row mb-3">
                                                <div class="col-md-6">
                                                    <div class="form-floating mb-3 mb-md-0">
                                                        ...
                                                        <label for="inputFirstName">Ingresar Primer Nombre</label>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-floating">
                                                        <input class="form-control" id="inputLastName" type="text" placeholder="Primer Apellido" />
                                                        <label for="inputLastName"> Ingresar Primer Apellido</label>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-floating mb-3">
                                                <input class="form-control" id="inputText" type="text" placeholder="Ingrese Usuario" />
                                                <label for="inputEmail">Ingresar Usuario</label>
                                            </div>
                                            <div class="row mb-3">
                                                <div class="col-md-6">
                                                    <div class="form-floating mb-3 mb-md-0">
                                            ...
                                            <div class="mt-4 mb-0">
                                                <div class="d-grid"><a class="btn btn-success btn-block" href="login.php">Crear Cuenta</a></div>
                                            </div>
                                        </form>
                                    </div>
