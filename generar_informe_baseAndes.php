...
WHERE TIP_CPLATAFORMA='ANDES' AND (TIP_CFECHA_GESTION) BETWEEN '$FECHA1' AND '$FECHA2'
order by TIP_NID";
  ...
  $fila = 2;
	...
	$objPHPExcel->getProperties ()->setCreator("Descargue_Base_Andes")->setDescription("Descargue_Base_Andes");
	$objPHPExcel->setActiveSheetIndex (0);

	$objPHPExcel->getActiveSheet ()->setTitle ("Descargue_Base_Andes");
    ...
    $objPHPExcel->getActiveSheet () -> setCellValue ('A2', print_r(sqlsrv_errors(),true));
		...
		header('Content-Disposition: attachment; filename="Informe_Andes.xlsx"');
