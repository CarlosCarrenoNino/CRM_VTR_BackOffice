...
$stmt = sqlsrv_query($conn, $sqlserver);
  ...
  $fila = 2;
	...
	$spread->getProperties ()->setCreator("Descargue_General_Tipificacion")->setDescription("Descargue_General_Tipificacion");
	
	$spread->setActiveSheetIndex (0);

		$spread->getActiveSheet ()->setTitle ("Descargue_General_Tipificacion");       
