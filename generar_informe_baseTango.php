...
$FECHA1 =  date('Y-m-d',strtotime($_POST['fecha-inicio_tango'])) ;
$FECHA2 = date('Y-m-d',strtotime($_POST['fecha-fin_tango'])) ;


if(isset($_POST['buttom_tango'])){
...
/* $sqlserver ="EXEC [SPR_SELECT_INFORME_TANGO] '".$FECHA1."','".$FECHA2."' "; */

$sqlserver ="SELECT 
  TIP_NID
 ,[TIP_CID_SS]
,[TIP_CNUMERO_SOLICITU]
,[TIP_CLOGICA]
,[TIP_CFECHA_REGISTRO]
,[TIP_CHORA_REGISTRO]
,[TIP_CFECHA_AGENDA]
...
,[TIP_CCASUISTICA]
,[TIP_CGESTION]
,[TIP_CREALIZAR_PRUEBAS]
,[TIP_CCOMO_SOLUCIONA]
,[TIP_CREPROGRAMAR]
,[TIP_CFECHA_REPROGRAMAR]
,[TIP_CHORA_REPROGRAMAR]
,[TIP_CFECHA_BLOQUE]
,[TIP_CBLOQUE]
,[TIP_COBSERVARCIONES]
,[TIP_CDETALLE1]
...
,[TIP_CDETALLE6]
,[TIP_CDETALLE7]
FROM [TBL_RTIPIFICACION_BACK_OFFICE]
WHERE TIP_CPLATAFORMA='TANGO' AND (TIP_CFECHA_GESTION) BETWEEN '$FECHA1' AND '$FECHA2'
order by TIP_NID";
...
$stmt = sqlsrv_query($conn, $sqlserver);
  ...
  $fila = 2;
	...
	$objPHPExcel->getProperties ()->setCreator("Descargue_Base_Tango")->setDescription("Descargue_Base_Tango");
	$objPHPExcel->setActiveSheetIndex (0);

	$objPHPExcel->getActiveSheet ()->setTitle ("Descargue_Base_Tango");
    ...
    $objPHPExcel->getActiveSheet () -> setCellValue ('A2', print_r(sqlsrv_errors(),true));
		...
		header('Content-Disposition: attachment; filename="Informe_Tango.xlsx"');
