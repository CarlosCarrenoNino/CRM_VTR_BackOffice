...
<html lang="es">
    ...
    <body class="sb-nav-fixed">
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-danger">
            <!-- Navbar Brand-->
            <a class="navbar-brand ps-3" href="backoffice.php"><b>VTR Back-Office</b></a>
            <!-- Sidebar Toggle-->
                    ...
                    <div class="sb-sidenav-menu">
                        <div class="nav">
                            ...
                            <a class="nav-link" href="index.php">
                                ...
                                BackOffice <?php echo  $_SESSION["UsuarioIngreso"]?>
                            </a>
                                            ...
                                            <label for="Cargar Andes"><b>Cargar Andes</b></label>
                                                <ul class="right_chat list-unstyled">
                                                    <li class="online">
                                                            ...
                                                            <form action="cargar_base_andes_spreed_backoffice.php" method="post" class="media" enctype="multipart/form-data">
                                                                <div>
                                                                <button type="submit" class="btn btn-link" name="upload-base_andes"><img src="carga.png" alt="Icono Cargar"><b></b></button>
                                            ...
                                            <label for="Cargar Tango"><b>Cargar Tango</b></label>
                                                <ul class="right_chat list-unstyled">
                                                    <li class="online">
                                                            ...
                                                            <form action="cargar_base_tango_spreed_backoffice.php" method="post" class="media" enctype="multipart/form-data">
                                                                <div>
                                                                <button type="submit" class="btn btn-link" name="upload-base_tango"><img src="carga.png" alt="Icono Cargar"><b></b></button>
